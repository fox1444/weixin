...
namespace QJY.WEB
{
    public class Global : System.Web.HttpApplication
    {
        ...
        {
            new JH_Auth_LogB().InsertLog("Application_Start", "Application启动", "Global.asax", "System", HttpContext.Current.Request.Url.Host.ToString(), 0, "");
        ...
        protected void Application_End(object sender, EventArgs e)
        {
            ...
            //更新AccessToken
            new JH_Auth_LogB().InsertLog("Application_End", "Application关闭", "Global.asax", "System", HttpContext.Current.Request.Url.Host.ToString(), 0, "");
            WXFWHelp.UpdateTokenByTimer();
        }
    }
}